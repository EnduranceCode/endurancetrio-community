...
import com.endurancetrio.data.insight.fixtures.AuthorFixture;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

/**
 * Unit test for the {@link Author} entity.
 * <p>
...
class AuthorTest {
  ...
  @BeforeEach
  void setUp() {
    underTest = AuthorFixture.standard();
  }

  @Test
  void entityShouldRetainValues() {
    assertEquals(AuthorFixture.STANDARD_ID, underTest.getId());
    assertEquals(AuthorFixture.STANDARD_KNOWN_NAME, underTest.getKnownName());
    assertEquals(AuthorFixture.STANDARD_BIO, underTest.getBio());
    assertNull(underTest.getProfileFileName());

...
/**
 * The {@link ResultStatusConverter} class is responsible for converting the {@link ResultStatus}
 * enum to its corresponding database column representation and vice versa.
 * <p>
 * This converter is used to persist the {@link ResultStatus} enum as a string in the database. It
...
public class ResultStatusConverter implements AttributeConverter<ResultStatus, String> {
  ...
  @Override
  public ResultStatus convertToEntityAttribute(String code) {
    return Stream.of(ResultStatus.values())
        .filter(resultStatus -> resultStatus.getCode().equals(code.toUpperCase()))
        .findFirst()

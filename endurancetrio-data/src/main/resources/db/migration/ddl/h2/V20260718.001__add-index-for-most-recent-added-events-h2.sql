...
-- Index for findMostRecentAddedEvents: orders event by created_at DESC
CREATE INDEX IF NOT EXISTS endurancetrio_hub.idx_event_created_at
  ON endurancetrio_hub.event (created_at DESC);

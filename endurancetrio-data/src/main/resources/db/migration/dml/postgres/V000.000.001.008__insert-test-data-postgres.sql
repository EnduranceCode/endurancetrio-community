...
INSERT INTO
  tracker_account (owner, account_key, enabled, version, created_at)
VALUES
  ('system', 'TEST_ACCOUNT_KEY_1234567890', TRUE, 0, CURRENT_TIMESTAMP);

-- Insert test data into tracking_data table
INSERT INTO
  tracking_data (id, account, device, record_time, latitude, longitude, active, version, created_at)
VALUES
...
SELECT setval('seq_tracking_data_id', 100, FALSE);

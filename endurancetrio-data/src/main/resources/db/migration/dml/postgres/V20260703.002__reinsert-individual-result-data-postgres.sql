...
-- Description: Re-inserts individual_result data for the 1984 Peniche triathlon event
--   with columns in the new order.
...
--
INSERT INTO
  individual_result (id, race_id, rank, source_result_id, penalty, athlete_id, age_group, para_class, team_id, team_name, bib, swim, first_bike, first_run, t1, bike, t2, run, second_run, t3, second_bike, total, points, version, created_at, updated_at)
VALUES

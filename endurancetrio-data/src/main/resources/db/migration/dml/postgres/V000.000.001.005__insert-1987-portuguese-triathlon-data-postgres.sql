...
SELECT setval('seq_event_id', 24, FALSE);
...
SELECT setval('seq_organizer_id', 22, FALSE);
...
SELECT setval('seq_event_file_id', 49, FALSE);
...
SELECT setval('seq_distance_id', 25, FALSE);


-- biathlon_distance table
--
INSERT INTO
  biathlon_distance (id, bike_distance, bike_laps, run_distance, run_laps)
VALUES
  (11, 50000, 1, 10000, 1),
  (12, 40000, 1, 10000, 1),
  (13, 37000, 1, 8000, 1),
...
-- double_biathlon_distance table
--
INSERT INTO
  double_biathlon_distance (id, first_bike_distance, first_bike_laps, first_run_distance, first_run_laps, second_bike_distance, second_bike_laps, second_run_distance, second_run_laps)
VALUES
...
SELECT setval('seq_course_id', 25, FALSE);
...
SELECT setval('seq_race_id', 92, FALSE);
...
SELECT setval('seq_results_file_id', 32, FALSE);

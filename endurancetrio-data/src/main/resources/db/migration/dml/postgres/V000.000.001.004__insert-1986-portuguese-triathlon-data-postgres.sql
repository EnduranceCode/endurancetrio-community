...
SELECT setval('seq_event_id', 9, FALSE);
...
SELECT setval('seq_organizer_id', 7, FALSE);
...
SELECT setval('seq_event_file_id', 16, FALSE);
...
SELECT setval('seq_distance_id', 9, FALSE);
...
SELECT setval('seq_course_id', 9, FALSE);
...
SELECT setval('seq_race_id', 22, FALSE);
...
SELECT setval('seq_results_file_id', 13, FALSE);

...
--
INSERT INTO
  author (id, known_name, bio, profile_file_name, athlete_id, version, created_at, updated_at)
VALUES
...
--
INSERT INTO
  article (id, slug, author_id, published_date, featured_image, featured_image_width, featured_image_height, version, created_at, updated_at)
VALUES
  (1, 'lorem-ipsum-1', 1, '2026-07-06 10:00:00', '/img/insights/lorem-ipsum-1.jpg', 1200, 628, 0, NOW(), null);

-- EN content for Article 1
INSERT INTO
  article_content (id, article_id, locale, title, subtitle, intro_text, full_text, meta_title, meta_description, version, created_at, updated_at)
VALUES
  (
    1,
    1,
...
INSERT INTO
  article_event (article_id, event_id)
VALUES
  (1, 1);
...
SELECT setval('seq_author_id', 3, FALSE);
SELECT setval('seq_article_id', 3, FALSE);
SELECT setval('seq_article_content_id', 4, FALSE);

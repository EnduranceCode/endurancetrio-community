...
--
UPDATE race SET race_status = 'PLANNED' WHERE id = 2;
UPDATE race SET race_status = 'COMPLETED' WHERE id = 3;


-- athlete table
--
INSERT INTO
  athlete (id, long_name, birth_name, known_name, gender, country, year_of_birth, version, created_at, updated_at)
VALUES
...
SELECT setval('seq_athlete_id', 31, FALSE);


-- individual_result table
--
INSERT INTO
  individual_result (id, race_id, rank, source_result_id, penalty, athlete_id, team_id, team_name, age_group, para_class, bib, swim, first_bike, first_run, t1, bike, t2, second_bike, run, t3, second_run, total, points, version, created_at, updated_at)
VALUES
...
SELECT setval('seq_individual_result_id', 61, FALSE);

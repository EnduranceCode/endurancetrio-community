...
SELECT setval('seq_event_id', 40, FALSE);
...
SELECT setval('seq_organizer_id', 34, FALSE);
...
SELECT setval('seq_event_file_id', 78, FALSE);
...
SELECT setval('seq_distance_id', 41, FALSE);
...
-- duathlon_distance table
--
INSERT INTO
  duathlon_distance (id, first_run_distance, first_run_laps, bike_distance, bike_laps, second_run_distance, second_run_laps)
VALUES
...
SELECT setval('seq_course_id', 41, FALSE);
...
SELECT setval('seq_race_id', 164, FALSE);
...
SELECT setval('seq_results_file_id', 59, FALSE);

...
/**
 * Fixture class providing pre-configured {@link AthleteDTO} instances for unit tests.
 * <p>
...
public class AthleteDTOFixtures {
  ...
  public static AthleteDTO standard() {
    return new AthleteDTO(AthleteFixture.STANDARD_ID, AthleteFixture.STANDARD_LONG_NAME, null,
        AthleteFixture.STANDARD_KNOWN_NAME, AthleteFixture.STANDARD_GENDER,
        AthleteFixture.STANDARD_COUNTRY, AthleteFixture.STANDARD_YEAR_OF_BIRTH
    );
  }

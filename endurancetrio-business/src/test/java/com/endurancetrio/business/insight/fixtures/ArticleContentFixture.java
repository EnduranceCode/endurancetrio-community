 ...
 * the {@code endurancetrio-business} module.
 * <p>
...
public class ArticleContentFixture {
  ...
  /**
   * Creates a standard {@link ArticleContent} entity with default test values.
   *
   * @return a standard ArticleContent entity instance
   */
